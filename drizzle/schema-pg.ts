...
export const thirdPartyStatusEnum = pgEnum("third_party_status", [
  "none",
  "synced",
  "error",
]);
export const userRoleSnapshotEnum = pgEnum("user_role_snapshot", [
  "consumer",
  "professional",
  "membership",
]);
export const proStatusSnapshotEnum = pgEnum("pro_status_snapshot", [
  "none",
  "pending",
  "approved",
  "rejected",
]);
export const cancellationRequestedByEnum = pgEnum("cancellation_requested_by", [
  "buyer",
  "admin",
]);
...
export const cancelTypeEnum = pgEnum("cancel_type", [
  "pre_payment",
  "post_payment",
]);
...
export const cardCancelTypeEnum = pgEnum("card_cancel_type", [
  "full",
  "partial",
]);
export const thirdPartyResultEnum = pgEnum("third_party_result", [
  "success",
  "failed",
  "skipped",
]);
...
export const profiles = pgTable("profiles", {
  ...
  landlinePhone: varchar("landlinePhone", { length: 30 }),
  ...
  membershipDiscountRate: integer("membershipDiscountRate")
    .notNull()
    .default(0),
  proVerificationStatus: proVerificationStatusEnum("proVerificationStatus")
    .notNull()
    .default("none"),
...
export type InsertBusinessVerification =
  typeof businessVerifications.$inferInsert;
...
export const products = pgTable("products", {
  ...
  priceConsumer: numeric("priceConsumer", {
    precision: 12,
    scale: 0,
  }).notNull(),
  ...
  priceConsumerOriginal: numeric("priceConsumerOriginal", {
    precision: 12,
    scale: 0,
  }),
...
export const orders = pgTable("orders", {
  ...
  discountAmount: numeric("discountAmount", { precision: 12, scale: 0 })
    .notNull()
    .default("0"),
  shippingAmount: numeric("shippingAmount", { precision: 12, scale: 0 })
    .notNull()
    .default("0"),
  finalAmount: numeric("finalAmount", { precision: 12, scale: 0 }).notNull(),
  status: orderStatusEnum("status").notNull().default("created"),
  shippingStatus: shippingStatusEnum("shippingStatus")
    .notNull()
    .default("none"),
  ...
  thirdPartyStatus: thirdPartyStatusEnum("thirdPartyStatus")
    .notNull()
    .default("none"),
...
export const orderCancellations = pgTable("order_cancellations", {
  ...
  requestedBy: cancellationRequestedByEnum("requestedBy")
    .notNull()
    .default("buyer"),
  reason: text("reason"),
...
export const orderRefunds = pgTable("order_refunds", {
  ...
  orderId: integer("orderId")
    .notNull()
    .references(() => orders.id),
  cancellationId: integer("cancellationId").references(
    () => orderCancellations.id
  ),
...
export const popups = pgTable("popups", {
  ...
  displayPosition: varchar("displayPosition", { length: 100 })
    .notNull()
    .default("main"),
...
export type InsertCertifiedInstructor =
  typeof certifiedInstructors.$inferInsert;
...
export const coupons = pgTable("coupons", {
  ...
  issueType: varchar("issueType", { length: 50 })
    .notNull()
    .default("customer_download"),
  targetMember: varchar("targetMember", { length: 20 })
    .notNull()
    .default("all"),
  displayTiming: varchar("displayTiming", { length: 20 })
    .notNull()
    .default("immediate"),
  ...
  productScope: varchar("productScope", { length: 20 })
    .notNull()
    .default("all"),
  minAmountType: varchar("minAmountType", { length: 30 })
    .notNull()
    .default("none"),
  minAmount: integer("minAmount").notNull().default(0),
  calcBasis: varchar("calcBasis", { length: 30 })
    .notNull()
    .default("before_discount"),
  maxUsagePerOrder: integer("maxUsagePerOrder").notNull().default(1),
  paymentMethodLimit: varchar("paymentMethodLimit", { length: 20 })
    .notNull()
    .default("none"),
...
export const discountCodes = pgTable("discount_codes", {
  ...
  minOrderAmountType: varchar("minOrderAmountType", { length: 20 })
    .notNull()
    .default("none"),
  minOrderAmount: integer("minOrderAmount").notNull().default(0),
  maxUsageType: varchar("maxUsageType", { length: 20 })
    .notNull()
    .default("none"),
  maxUsageCount: integer("maxUsageCount"),
  targetType: varchar("targetType", { length: 20 }).notNull().default("none"),
  samePersonLimitType: varchar("samePersonLimitType", { length: 20 })
    .notNull()
    .default("none"),
...
export const remindAlerts = pgTable("remind_alerts", {
  ...
  benefitTrigger: varchar("benefitTrigger", { length: 30 })
    .notNull()
    .default("order_complete"),
  benefitContent: varchar("benefitContent", { length: 30 })
    .notNull()
    .default("coupon"),
...
export const requestRateLimits = pgTable(
  ...
  table => ({
    expiresAtIdx: index("request_rate_limits_expires_at_idx").on(
      table.expiresAt
    ),
  })
);
...
export const couponIssuesRelations = relations(couponIssues, ({ one }) => ({
  coupon: one(coupons, {
    fields: [couponIssues.couponId],
    references: [coupons.id],
  }),
  user: one(profiles, {
    fields: [couponIssues.userId],
    references: [profiles.id],
  }),
}));
